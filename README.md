...
| enumType          |          `"stringUnion" \| "enum" \| "both"`           |                              `"stringUnion"`                               | Controls how enums are generated. `"enum"` will create Typescript enums, `"stringUnion"` will create union types with all the enum values. and `"both"` will do both.                                  |
